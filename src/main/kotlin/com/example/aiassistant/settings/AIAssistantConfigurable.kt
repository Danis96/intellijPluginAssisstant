...
class AIAssistantConfigurable : Configurable {
	...
	private fun createTokenCard(): JPanel {
		...
		val required: JLabel = JLabel(TextHelper.Settings.REQUIRED_LABEL)
		...
		actionsRow.border = EmptyBorder(0, 0, 0, 0)
		...
		actionsRow.add(Box.createHorizontalStrut(28)) // was 12; now larger gap
