...
class CheckCodeInAssistantAction : AnAction(TextHelper.Prompts.CHECK_CODE_ACTION_TEXT) {
	...
	override fun actionPerformed(e: AnActionEvent) {
		...
		val promptText: String = TextHelper.format(TextHelper.Prompts.CHECK_CODE_TEMPLATE, codeBlock)
