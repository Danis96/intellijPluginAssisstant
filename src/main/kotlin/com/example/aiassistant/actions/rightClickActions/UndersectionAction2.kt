...
// NOTE Action does the same as CheckCodeInAssistantAction, but it's for undersection2.

class Undersection2Action : AnAction(TextHelper.Prompts.UNDERSECTION2_ACTION_TEXT) {
	...
	override fun actionPerformed(e: AnActionEvent) {
		...
		val promptText: String = TextHelper.format(TextHelper.Prompts.UNDERSECTION2_TEMPLATE, codeBlock)
